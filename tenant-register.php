...
<div class="container" style="margin-top: 120px;">
  ...
  <form method="POST" action="tenant-engine.php" enctype="multipart/form-data" style="font-size: 14px">
    ...
    <div class="form-group text-right">
      <label class="">Register as a <a href="owner-register.php">Hostel Owner</a>?</label><br>
    </div><br><br>
  </form>
</div>
