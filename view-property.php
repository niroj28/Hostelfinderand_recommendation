...
$property_id=$_GET['property_id'];
 ...
 //    $sql="SELECT * from add_Hostel where Hostel_id='$Hostel_id'";
...
<div class="col-sm-4"> 
  <center><h2><?php echo $rows['property_type'] ?></h2></center> <br>
<table>
            <tr>
              <td><h3>AREA :</h3></td>
...
<div class="row">
  <div class="col-sm-5">
    ...
    <input type="submit" class="btn btn-lg btn-primary" name="book_property" style="width: 100%" value="Book Hostel">
  <?php } else { ?>
    <input type="submit" class="btn btn-lg btn-primary" style="width: 100%" value="Hostel Booked" disabled>
  <?php } ?>
  </div>
</form>
<form method="POST" action="chatpage.php" style="width: 50%">
  <div class="col-sm-5">
...
<?php }
  ...
  echo "<center><h3>You should login to book Hostel.</h3></center>";
}
...
<div class="container-fluid">
  <h2>Review Hostel:</h2>
      <div class="well well-sm">
            <div class="text-right"style=" font-size: 25px !important;">
<?php 
      
if(isset($_SESSION["email"]) && !empty($_SESSION['email'])){
?>
                <a class="btn btn-success btn-info" href="#reviews-anchor" style="width: 100%; height: 50px; font-size: 24px" id="open-review-box" >Leave a Review</a>
            </div>
        
            <div class="row" id="post-review-box" style="display:none;">
                <div class="col-md-12">
                    <form accept-charset="UTF-8" method="POST">
                      <input name="Hostel_id" type="hidden" value="<?php echo $Hostel_id; ?>">
              ...
              <?php } 
                ...
                echo "<center>You should login to review Hostel.</center>";
              }
              ?>
