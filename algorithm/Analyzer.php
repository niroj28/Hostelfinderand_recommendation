...
// $output_text = $analyzer->getSentiment("This hostel is very good for student");

// $output_emoji = $analyzer->getSentiment("😁");
$result="bad bad hostel";
$output_text_with_emoji = $analyzer->getSentiment($result);

// print_r($output_text);
// print_r($output_emoji);
print_r($output_text_with_emoji["neg"]*100);
