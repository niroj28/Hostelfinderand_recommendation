...
<body>
 ...
 <div class="container-fluid">
  <ul class="nav nav-pills nav-justified">
    ...
    <li style="background-color: #FAF0E6"><a data-toggle="pill" href="#menu1">Hostel Owners Details</a></li>
    <li style="background-color: #FFFACD"><a data-toggle="pill" href="#menu2">Students Details</a></li>
    <li style="background-color: #FAFACD"><a data-toggle="pill" href="#menu3">Booked Hostels</a></li>
    <li style="background-color: #FAF0E6"><a href="review.php">Hostel review</a></li>
     <?php 
if(isset($_SESSION["email"]) && !empty($_SESSION['email'])){
  ...
  <div class="tab-content">
    <div id="home" class="tab-pane fade in active">
      ...
      <center style="margin-top:120px;"><h3>Hostel Lists</h3></center>
      <div class="container-fluid">
...
<?php $sql2="SELECT * from property_photo where property_id='$property_id'";
    ...
    <div id="menu1" class="tab-pane fade">
      <center style="margin-top:120px;"><h3>Hostel Owner Details</h3></center>
      <div class="container-fluid">
    ...
    <div id="menu3" class="tab-pane fade">
      <center><h3>Booked Hostels</h3></center>
      <div class="container">
