...
<div class="container">
  <h3 style="font-weight: bold; text-align: center; margin-top: 120px;">Hostel Owner Register</h3><hr><br>
  <form method="POST" action="owner-engine.php" enctype="multipart/form-data" style="font-size: 14px;">
